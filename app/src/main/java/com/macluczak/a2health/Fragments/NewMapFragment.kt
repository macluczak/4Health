...
//                        val urlDirections =
//                            "https://maps.googleapis.com/maps/api/directions/json?destination=${origin.position.latitude},${origin.position.longitude}&origin=${destination.position.latitude},${destination.position.longitude}&key=${key}"
